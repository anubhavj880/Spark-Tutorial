 ...
 *
 */
public class Tranformation_RDD_join {
	...
	public static void main(String[] args) {
		...
		JavaRDD<String> distFile1 = sc.textFile("src/Resource/text/data2.txt");
		...
		JavaPairRDD<Integer, String> rdd1 = distFile2.mapToPair(new PairFunction<String, Integer, String>() {
		...
		JavaPairRDD<Integer, String> rdd2 = distFile2.mapToPair(new PairFunction<String, Integer, String>() {
		...
		System.out.println(finalrdd.collect());
	}
